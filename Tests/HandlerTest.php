...
class HandlerTest extends TestCase
{
    ...
    public function testHttpRequest_13()
    {
        ...
        $this->assertEquals(
            '[{"jsonrpc":"2.0","result":7,"id":"1"},{"jsonrpc":"2.0","result":19,"id":"2"},{"jsonrpc":"2.0","error":{"code":-32600,"message":"Invalid Request"},"id":null},{"jsonrpc":"2.0","error":{"code":-32601,"message":"Method not found","data":"foo.get"},"id":"5"},{"jsonrpc":"2.0","result":["hello",5],"id":"9"}]',
            $response->getContent(),
            $response->getContent()
        );
    }
    ...
    public function testHttpRequest_14()
    {
        ...
        $this->assertEquals(
            '{"jsonrpc":"2.0","error":{"code":-32002,"message":"Method exception","data":"Exception data"},"id":"1"}',
            $response->getContent(),
            $response->getContent()
        );
    }
