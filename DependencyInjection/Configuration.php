    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ->children()
                ...
                ->end()
                ->arrayNode('proxy')
                    ->addDefaultsIfNotSet(['enable'=>false,'client'=>['type'=>'json','address' => [],'options'=>['forward_headers'=>[],'forward_cookies'=>[],'forward_ip'=>true,'forward_locale'=>true]]])
                    ->children()
                        ->variableNode('enable')->defaultValue(false)->end()
                        ->arrayNode('client')
                            ->addDefaultsIfNotSet(['type'=>'json','address' => [],'options'=>['forward_headers'=>[],'forward_cookies'=>[],'forward_ip'=>true,'forward_locale'=>true]])
                            ->children()
